...
game.party.push(pokemon [5], pokemon [150], pokemon[53]);
...
*/
const gymCompleted = game.gyms.map(gym => {
    if (gym.difficulty < 3) {
      gym.completed = true
      console.log(game)
    } else {
...
game.gymStatus = function() {
    ...
    return { completed: gymComplete, incomplete: gymIncomplete};
}
...
const gymCompleter = game.gyms.map(gym => {
    if (gym.difficulty < 8) {
      gym.completed = true
      console.log(game)
    } else {
